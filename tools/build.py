...
def build_legal():
    ...
    out.append(legal_page("privacy", "Privacy Policy", "Legal", "Privacy <em>policy.</em>",
      ...
      <p>Enquiries that do not become orders: 24 months from your last contact with us. Order records: seven years in our order database, which is what tax and commercial record-keeping requires. Server logs: as retained by our hosting provider, typically around 30 days.</p>
